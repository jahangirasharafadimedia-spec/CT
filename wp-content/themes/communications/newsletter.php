...
$fields = get_field_objects($_GET['post']);
if(!$fields){
                                ...
                                <tr>
                                    <td width="440">
                                        <a href="https://www.communicationstoday.co.in/">
                                            <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-11.png" width="100%">
                                        </a>
                                    </td>
                                    <td align="right" style="" width="160">
                                        ...
                                        <span style="font-size:13px;font-family: 'Roboto Condensed', sans-serif; "><?php echo getWeekday($fields['date']['value']); ?></span>   
                                    </td>
                                </tr>
                            </tbody></table>
                        </td>
                            ...
                            <td align="center">
                                <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/06/unnamed.png" width="100%">
                                            </td>
                                        </tr>
                                        <tr><td height="20"></td></tr>
                                    </tbody>
                                        ...
                                        <table class="col2" width="260" border="0" align="right" cellpadding="0" cellspacing="0">
                                            <tbody><tr>
                                                <td align="center" style="line-height:0px;">
                                                    <?php if($fields['perspective_banner']['value']){ ?>
                        ...
                        <td align="center">
                            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-01.png" width="100%">
                                        </td>
                                    </tr>
                                    <tr><td height="20"></td></tr>
                                </tbody>
                            ...
                            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                                                            ...
                                                            <tbody>
                                                                <tr valign="top">
                                                                    ...
                                                                    <a href="<?php echo esc_url( get_permalink($fields['exclusive']['value']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">
                                                                        <img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($fields['exclusive']['value']->ID ) ); ?>" style="width:300px;" height="150"> </a>
                                                                    </td>
                                                                </tr>
                                                                <tr align="left">
                                                                    <td>
                                ...
                                <td valign="top" style="padding: 0;">
                                    <table class="col2" width="260" border="0" align="right" cellpadding="0" cellspacing="0">
                                        <tbody><tr>
                                            <td align="center" style="line-height:0px;">
                                                <?php if($fields['exclusive_banner']['value']){ ?>
                    ...
                    <td align="center">
                        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                            <tbody>
                                ...
                                <tr>
                                    <td align="center">
                                        <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-02.png" style="display:block" width="100%">
                                    </td>
                                </tr>
                                <tr><td height="20"></td></tr>
                            </tbody>
                        ...
                        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                                                        ...
                                                        <tbody>
                                                            <tr valign="top">
                                                                ...
                                                                <a href="<?php echo esc_url( get_permalink($fields['headlines_post']['value']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">
                                                                    <img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($fields['headlines_post']['value']->ID ) ); ?>" style="width:300px;" height="150"> </a>
                                                                </td>
                                                            </tr>
                                                            <tr align="left">
                                                                <td>
                            ...
                            <td valign="top" style="padding: 0;">
                                <table class="col2" width="260" border="0" align="right" cellpadding="0" cellspacing="0">
                                    <tbody><tr>
                                        <td align="center" style="line-height:0px;">
                                            <?php if($fields['headlines_banner']['value']){ ?>
                ...
                <td align="center">
                    <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                        <tbody>
                            ...
                            <tr>
                                <td align="center">
                                    <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-08.png" width="100%">
                                </td>
                            </tr>
                            <tr><td height="20"></td></tr>
                        </tbody>
                ...
                <td align="center">
                    <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                        <tbody>
                            ...
                            <tr>
                                <td align="center">
                                    <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-07.png" width="100%">
                                </td>
                            </tr>
                            <tr><td height="20"></td></tr>
                        </tbody>
                    ...
                    <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                                                    ...
                                                    <tbody>
                                                        <tr valign="top">
                                                            ...
                                                            <a href="<?php echo esc_url( get_permalink($fields['exclusive_feature_post']['value']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">
                                                                <img src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($fields['exclusive_feature_post']['value']->ID ) ); ?>" style="width:300px;" height="150"> </a>
                                                            </td>
                                                        </tr>
                                                        <tr align="left">
                                                            <td>
                        ...
                        <td valign="top" style="padding: 0;">
                            <table class="col2" width="260" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tbody><tr>
                                    <td align="center" style="line-height:0px;">
                                        <?php if($fields['exclusive_feature_banner']['value']){ ?>
            ...
            <td align="center">
                <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                    <tbody>
                        ...
                        <tr>
                            <td align="center">
                                <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-10.png" width="100%">
                            </td>
                        </tr>
                        <tr><td height="20"></td></tr>
                    </tbody>
                ...
                <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                                        ...
                                        <td align="center">
                                            <table class="insider" width="287" border="0" align="center" cellpadding="0" cellspacing="0">
                                                ...
                                                <tbody>
                                                    <tr valign="top">
                                                        <td>
                                                            <?php if($fields['editorial_post_image']['value']){ ?>
                    ...
                    <td valign="top" style="padding: 0;">
                        <table class="col2" width="260" border="0" align="right" cellpadding="0" cellspacing="0">
                            <tbody><tr>
                                <td align="center" style="line-height:0px;">
                                    <?php if($fields['editorial_feature_banner']['value']){ ?>
        ...
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                <tbody>
                    ...
                    <tr>
                        <td align="center">
                            <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-02.png" width="100%">
                        </td>
                    </tr>
...
foreach($fields['headlines_of_the_day']['value'] AS $data){
        ...
        <?php if($data['image']){ ?>
            <td align="center">
                <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                    <tbody>
                        <td align="right">
                            <table class="col2" width="185" border="0" align="left" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td align="center" style="line-height:0px;">
                                                <?php if($data['headlines']->ID){ ?>
                                            <a href="<?php echo esc_url( get_permalink($data['headlines']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">
                                                <img style="display:block; line-height:0px; font-size:0px; border:0px;" class="images_style" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($data['headlines']->ID ) ); ?>" width="180" height="120">
                                            </a>
                                        <?php } ?>
                                        </td>
                                    </tr>
                        ...
                        <td valign="top">
                            <table width="390" border="0" align="right" cellpadding="0" cellspacing="0" class="col2" style="">
                                <tbody>
                                    <tr>
                                        <td align="center">
                                            <table class="insider" style="width: 390px;" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    ...
                                                    <tr align="left">
                                                        <td>
                                                            <a href="<?php echo esc_url( get_permalink($data['headlines']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>" style="text-decoration:none;font-family: 'Roboto Condensed', sans-serif; font-size:15px; color:#2a3b4c;line-height:20px; font-weight: bold;"><?php echo $data['headlines']->post_title;?>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-family: 'Roboto Condensed', sans-serif; font-size:15px; color:#444;line-height:24px; font-weight: 300;"><?php echo limit_text($data['headlines']->post_content,13); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="<?php echo esc_url( get_permalink($data['headlines']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>" class="readmore" style="text-decoration:none;font-family: 'Roboto Condensed', sans-serif; font-size:14px; color:#0066cc; line-height:24px; font-weight:bold;"><i>Read more</i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <td align="left">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="<?php echo esc_url( get_permalink($data['headlines']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>" style="text-decoration:none;font-family: 'Roboto Condensed',sans-serif;width:600px; font-size:15px; color:#2a3b4c;line-height:20px; font-weight: bold;"><?php echo $data['headlines']->post_title;  ?>
                        </a>
                    </td>
                </tr>
            </tbody>
                    ...
                    <tr>
                        <td align="center">
                            <a href="<?php echo $fields['banner_3_link']['value']; ?>" target="_blank">
                                <img src="<?php echo $fields['banner_3']['value']; ?>" width="100%">
                            </a>
                        </td>
                    </tr>
    ...
    <td align="center">
        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
            <tbody>
                ...
                <tr>
                    <td align="center">
                        <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-06.png" width="100%">
                    </td>
                </tr>
                <tr><td height="20"></td></tr>
            </tbody>
...
<!-- Company News with image -->        

<?php 

foreach($fields['company_news']['value'] AS $data){
                        ...
                        <td align="right">
                            <table class="col2" width="185" border="0" align="left" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td align="center" style="line-height:0px;">
                                            <a href="<?php echo esc_url( get_permalink($data['news']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">
                                                <img style="display:block; line-height:0px; font-size:0px; border:0px;" class="images_style" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($data['news']->ID ) ); ?>" width="180" height="120">
                                            </a>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <td valign="top">
                            <table width="390" border="0" align="right" cellpadding="0" cellspacing="0" class="col2" style="">
                                <tbody>
                                    <tr>
                                        <td align="center">
                                            <table class="insider" width="390" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    <tr align="left">
                                                    </tr>
                                                    <tr align="left">
                                                        <td>
                                                            <a href="<?php echo esc_url( get_permalink($data['news']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>" style="text-decoration:none;font-family: 'Roboto Condensed', sans-serif; font-size:15px; color:#2a3b4c;line-height:20px; font-weight: bold;"><?php echo $data['news']->post_title;  ?>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-family: 'Roboto Condensed', sans-serif; font-size:15px; color:#444;line-height:24px; font-weight: 300;"><?php echo limit_text($data['news']->post_content,17); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="<?php echo esc_url( get_permalink($data['news']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>" class="readmore" style="text-decoration:none;font-family: 'Roboto Condensed', sans-serif; font-size:14px; color:#0066cc; line-height:24px; font-weight:bold;"><i>Read more</i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<?php if($fields['banner_4']['value']){ ?>
        ...
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                <tbody>
                    ...
                    <tr>
                        <td align="center">
                            <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-03.png" width="100%">
                        </td>
                    </tr>
                    <tr><td height="20"></td></tr>
                </tbody>
    ...
    <!-- International Circuit with image -->       

    <?php 

    foreach($fields['international_circuit']['value'] AS $data){
                    ...
                    <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                        <tbody>
                            <td align="right" valign="top">
                                <table class="col2" width="185" border="0" align="left" valign cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td align="center" style="line-height:0px;">
                                                <a href="<?php echo esc_url( get_permalink($data['news']->ID)); ?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">
...
<?php if($fields['banner_5']['value']){ ?>
        ...
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                <tbody>
                    ...
                    <tr>
                        <td align="center">
                            <a href="<?php echo $fields['banner_5_link']['value']; ?>" target="_blank">
                                <img src="<?php echo $fields['banner_5']['value']; ?>" width="100%">
                            </a>
                        </td>
                    </tr>
        ...
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                <tbody>
                    ...
                    <tr>
                        <td align="center">
                            <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-09.png" width="100%">
                        </td>
                    </tr>
                    <tr><td height="20"></td></tr>
                </tbody>
    ...
    foreach($fields['trends']['value'] AS $data){
        ...
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                <tbody>
                    ...
                    <tr>
                        <td align="center">
                            <img src="https://www.communicationstoday.co.in/wp-content/uploads/2021/05/webinar.jpg" width="100%">
                        </td>
                    </tr>
                    <tr><td height="20"></td></tr>
                </tbody>
        ...
        <td align="center">
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
                <tbody>
                    <tr>
                        <td align="center">
                            <a href="<?php echo $fields['webinar_link']['value'];?>?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">

                                <img src="<?php echo $fields['webinar']['value']; ?>" style="width:100%">
    ...
    <td align="center">
        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
            <tbody>
                ...
                <tr>
                    <td align="center">
                        <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-05.png" width="100%">
                    </td>
                </tr>
                <tr><td height="20"></td></tr>
            </tbody>
...
foreach($fields['reports']['value'] AS $data){
    ...
    <td align="center">
        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
            <tbody>
                ...
                <tr>
                    <td align="center">
                        <img src="https://www.communicationstoday.co.in/wp-content/uploads/2023/05/CT-DN-04.png" width="100%">
                    </td>
                </tr>
                <tr><td height="20"></td></tr>
            </tbody>
    ...
    <td align="center">
        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="">
            <tbody>
                <tr>
                    <td align="center">
                        <a href="https://www.communicationstoday.co.in/ezine/?utm_source=newsletter&utm_medium=email&utm_campaign=<?php echo $utm_campaign; ?>">

                            <img src="<?php echo $fields['ezine_banner']['value']; ?>" style="width:100%">
