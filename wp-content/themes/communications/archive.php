<?php
/**
 * Archive pages: category, tag, author, date, post type (custom templates e.g. archive-ct_video.php).
 *
...
if ( function_exists( 'communicationstoday_is_perspective_category_archive' ) && communicationstoday_is_perspective_category_archive() ) {
